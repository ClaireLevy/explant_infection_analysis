...
#order the factors nicely
explant_infection_005$Day <- factor(explant_infection_005$Day, levels = c("1","1 wash","3","6","8","10","13","15","17","20"))


#for some reason the exo per pfu shows up as actual numbers, not scientific notation, even though it is is sci not in excel... plater bug?

explant_infection_005$Exo_per_pfu <- mapvalues(explant_infection_004$Exo_per_pfu, from = c("10000","100000","1000","50000"), to = c("1e4","1e5","1e3","5e4"))
...
compiled <- list(explant_infection_005,explant_infection_004,explant_infection_002,explant_infection_001, virus_preinc_003)

names(compiled) <- c("explant_infection_005","explant_infection_004","explant_infection_002","explant_infection_001", "virus_preinc_003")
